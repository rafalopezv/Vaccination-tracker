---
title: 'PROGRESO GLOBAL DE VACUNACIÓN'
output: 
  html_document: 
    css: style.css
---
...
El proceso de vacunación no ocurre de la misma manera en las diferentes regiones del mundo. ¿Por qué algunos países avanzan a gran velocidad y por qué algunos otros apenas están comenzando? [**En Avina**](https://www.avina.net/en/home/) estamos estamos trabajando para que la vacuna sea un bien público universal y esperamos que este espacio ayude a generar conciencia sobre ello. Las grandes desigualdades nunca son son justas, pero mucho menos cuando hay vidas en juego.

La tabla es interactiva. Si se hace click sobre el título de las columnas, los registros de datos se ordenarán por orden alfabético o de mayor a menor (y viveversa), dependiendo si los datos son alfabéticos o numéricos.  
