...
El proceso de vacunación no ocurre de la misma manera en las diferentes regiones del mundo. ¿Por qué algunos países avanzan a gran velocidad y por qué algunos otros apenas están comenzando? [**En Avina**](https://www.avina.net/en/home/) estamos estamos trabajando para que la vacuna sea un bien público universal y esperamos que este espacio ayude a generar conciencia. Las grandes desigualdades nunca son son justas, pero mucho menos cuando hay vidas en juego.
...
- La columna "Personas vacunadas la semana pasada [%]" calcula a semana como los 6 días anteriores a la fecha de la última medición"
- La columna "Semanas hasta concluir a vacunación al rirtmo actual"  calcula al 100% de la población, incluyendo a aquella mayor a 16 años. 
- Se excluyen:
  - Países que no hayn mostrado ningún progreso en los últimos 7 días desde su último reporte

<hr>
Menciones

La tabla utilizó las siguientes fuentes como inspiración de trabajo.

- [New York Times](https://www.nytimes.com/interactive/2021/01/25/world/europe/global-vaccination-population-rate.html)
- [Kyle Cuilla](https://rpubs.com/kcuilla/nfl_team_ratings)
